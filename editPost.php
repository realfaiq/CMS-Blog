                ...
                <form action="editPost.php?Edit=<?php echo $searchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                   <fieldset>
                       <div class="form-group">
                           ...
                           <input type="text" value="<?php echo $titleToBeUpdated; ?>" class="form-control" name="title" id="Title" placeholder="Title">
                       </div>
                       ...
                       <input type="submit" value="Update Post" name="submit" class="btn btn-success btn-block mb-2">
                   </fieldset>
               </form>
