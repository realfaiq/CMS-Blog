                   ...
                   <div><?php echo ErrorMessage();
                    ...
                    <?php
                        ...
                        foreach($data as $value){
                            $titleToBeUpdated = $value['title'];
                            $categoryToBeUpdated = $value['category'];
                            $imageToBeUpdated = $value['image'];
                            $postToBeUpdated = $value['post'];
                        }
                    ?>
                <form action="deletePost.php?Delete=<?php echo $searchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                   <fieldset>
                       <div class="form-group">
                           ...
                           <input type="text" disabled value="<?php echo $titleToBeUpdated; ?>" class="form-control" name="title" id="Title" placeholder="Title">
                       </div>
                       ...
                       <input type="submit" value="Delete Post" name="submit" class="btn btn-danger btn-block mb-2">
                   </fieldset>
               </form>
